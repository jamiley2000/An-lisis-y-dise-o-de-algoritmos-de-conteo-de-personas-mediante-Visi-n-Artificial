...
int main() {
	...
	VideoWriter writer = VideoWriter("Video2_TestVideo.avi/640x480_15fps/MOG2/640x480_15fps.avi", VideoWriter::fourcc('X', 'V', 'I', 'D'), 15, Size(Cap.get(cv::CAP_PROP_FRAME_WIDTH), Cap.get(cv::CAP_PROP_FRAME_HEIGHT)));
	VideoWriter writer2 = VideoWriter("Video2_TestVideo.avi/640x480_15fps/MOG2/640x480_15fps_SDF.avi", VideoWriter::fourcc('X', 'V', 'I', 'D'), 15, Size(Cap.get(cv::CAP_PROP_FRAME_WIDTH), Cap.get(cv::CAP_PROP_FRAME_HEIGHT)), false);
	/*--- Inicialización de variables ---*/
	ofstream archivo("Video2_TestVideo.avi/640x480_15fps/MOG2/TiemposProcesamiento.txt", fstream::out);
	ofstream Archivo2("Video2_TestVideo.avi/640x480_15fps/MOG2/PersonasContadas.txt", fstream::out);
	/*--- Inicialización de variables ---*/
	Mat Frame1, Frame2;
	/*--- Inicialización de variables ---*/
	...
	int frame = 1;
	/*--- Inicialización de variables ---*/
	Ptr<BackgroundSubtractorMOG2> subtractor = createBackgroundSubtractorMOG2(500, 16, true);
	/*--- Inicialización de variables ---*/
