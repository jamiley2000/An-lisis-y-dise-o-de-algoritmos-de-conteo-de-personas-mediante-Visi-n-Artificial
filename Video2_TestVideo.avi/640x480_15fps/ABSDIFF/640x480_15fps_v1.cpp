...
int main() {
	...
	VideoWriter writer = VideoWriter("Video2_TestVideo.avi/640x480_15fps/ABSDIFF/640x480_15fps.avi", VideoWriter::fourcc('X', 'V', 'I', 'D'), 15, Size(Cap.get(cv::CAP_PROP_FRAME_WIDTH), Cap.get(cv::CAP_PROP_FRAME_HEIGHT)));
	VideoWriter writer2 = VideoWriter("Video2_TestVideo.avi/640x480_15fps/ABSDIFF/640x480_15fps_SDF.avi", VideoWriter::fourcc('X', 'V', 'I', 'D'), 15, Size(Cap.get(cv::CAP_PROP_FRAME_WIDTH), Cap.get(cv::CAP_PROP_FRAME_HEIGHT)), false);
	/*--- Inicialización de variables ---*/
	ofstream archivo("Video2_TestVideo.avi/640x480_15fps/ABSDIFF/TiemposProcesamiento.txt", fstream::out);
	ofstream Archivo2("Video2_TestVideo.avi/640x480_15fps/ABSDIFF/PersonasContadas.txt", fstream::out);
	/*--- Inicialización de variables ---*/
